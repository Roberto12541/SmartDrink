        ...
        <div className="p-4 md:p-8 max-w-[1200px] mx-auto">
            <div className="bg-black rounded-[2rem] md:rounded-[4rem] p-8 sm:flex sm:items-center md:p-12 sm:justify-center">
                <div className="md:w-6/12">
                    ...
                    <button className="transition border bg-white w-full py-4 rounded-full hover:bg-black hover:text-white hover:border-white hover:scale-105 sm:w-auto sm:px-14"><Link to={'/nosotros'}>Conócenos</Link></button>
                </div>
