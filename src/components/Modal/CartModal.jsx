...
const CartModal = () => {
    ...
    const modal = state ? "block relative z-50" : "hidden relative z-50"

    return (
        <div className={modal} id="drawer-right-example" tabIndex={-1} aria-labelledby="drawer-right-label">
                                ...
                                <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="ml-3 flex h-7 items-center">
                                            <button type="button" className="-m-2 p-2 text-gray-400 hover:text-gray-500" onClick={changeState}>
