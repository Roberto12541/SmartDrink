    ...
    return (
        <div className="hidden items-center lg:flex">
            ...
            <div className="relative w-full">
                ...
                <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Buscar" required value={busqueda} onChange={(e) => setBusqueda(e.target.value)}/>
            </div>
            <Link to={`/search/${busqueda}`} className="hidden lg:block p-2.5 ml-2 text-sm font-medium text-white bg-black rounded-lg border hover:scale-105 focus:ring-blue-300">
