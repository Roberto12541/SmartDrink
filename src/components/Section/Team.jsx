                        ...
                        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            ...
                            <div className="flex-grow sm:pl-8">
                                ...
                                <span className="inline-flex">
                                    <a href='https://www.facebook.com/macv2002' className="text-gray-500">
                                    ...
                                    <a href='https://api.whatsapp.com/send/?phone=525564100068&text&app_absent=0' className="ml-2 text-gray-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-whatsapp w-5 h-5 text-white" viewBox="0 0 16 16">
