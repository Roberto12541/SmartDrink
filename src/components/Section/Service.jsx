        ...
        <div className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-8 mx-auto">
                ...
                <div className="flex justify-center mt-8">
                    <button className="px-8 py-2 tracking-wide text-white capitalize transition-colors border duration-300 transform bg-black rounded-md hover:bg-white hover:text-black hover:border-black">
                        Obtener plan
                    </button>
                </div>
            </div>
