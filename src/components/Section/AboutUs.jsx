        ...
        <>
            <section className="grid grid-cols-1 gap-0 bg-opacity-25 md:grid-cols-2">
                <div className="flex flex-col items-start bg-black justify-center px-4 py-24 lg:px-20">
                    ...
                    <p className="pr-0 mb-4 text-lg text-white tracking-relaxed text-justify lg:pr-16">Somos un equipo de desarrolladores que busca
                        innovar y agilizar la preparacion de bebidas
                        de nuestros clientes con metodos tecnológicos
                        ya que queremos que nuestros clientes se posicionen
                        entre los mejores siendo originales y autenticos.</p>
                </div>
                <div>
            ...
            <section className="grid grid-cols-1 gap-0 bg-opacity-25 md:grid-cols-2">
                ...
                <div className="flex flex-col items-start justify-center px-4 py-24 lg:px-20 order-1 md:order-2">
                    ...
                    <p className="pr-0 mb-4 text-lg text-black tracking-relaxed text-justify lg:pr-24">Ser reconocidos a nivel nacional e internacional
                        siendo originales, profesionales y teniendo la mejor
                        calidad humana y principios eticos para ofrecer nuestros
